...
const ScientistsSection = () => (
  <section className="bg-white font-['Inter',sans-serif] text-[#111827]">
    ...
    <div className="overflow-x-auto overflow-y-hidden pb-[38px]">
      <div className="flex min-w-max gap-[39px] px-0 md:gap-[39px]">
        {scientists.map((scientist) => (
          <article key={scientist.name} className="relative h-[464px] w-[238px] shrink-0 bg-[#d5d5d5] md:w-[291px]">
